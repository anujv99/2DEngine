...
#define TIME_THIS_SCOPE		TimeThis timer(__FILE__, __FUNCTION__, __LINE__, false)
#define TIME_THIS_SCOPE_MS	TimeThis timer(__FILE__, __FUNCTION__, __LINE__, true)
